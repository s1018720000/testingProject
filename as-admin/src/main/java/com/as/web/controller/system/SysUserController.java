...
public class SysUserController extends BaseController
{
    ...
    public AjaxResult addSave(@Validated SysUser user)
    {
        ...
        {
            return error(MessageUtils.message("user.add") + " '" + user.getLoginName() + "' " + MessageUtils.message("user.add.failed"));
        }
        else if (StringUtils.isNotEmpty(user.getEmail())
                && UserConstants.USER_EMAIL_NOT_UNIQUE.equals(userService.checkEmailUnique(user)))
        {
            return error(MessageUtils.message("user.add") + " '" + user.getLoginName() + "' " + MessageUtils.message("user.add.failed.mail"));
        }
    ...
    public AjaxResult editSave(@Validated SysUser user)
    {
        ...
        if (StringUtils.isNotEmpty(user.getEmail())
                && UserConstants.USER_EMAIL_NOT_UNIQUE.equals(userService.checkEmailUnique(user)))
        {
            return error(MessageUtils.message("user.modify") + " '" + user.getLoginName() + "' " + MessageUtils.message("user.add.failed.mail"));
        }

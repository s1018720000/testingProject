...
import com.as.common.core.domain.entity.SysDictType;
...
import com.as.system.service.ISysDictTypeService;
...
public class SysDictTypeController extends BaseController
{
    ...
    public AjaxResult addSave(@Validated SysDictType dict)
    {
        ...
        {
            return error( MessageUtils.message("dict.add") + " '" + dict.getDictName() + "' " + MessageUtils.message("dict.add.failed"));
        }
    ...
    public AjaxResult editSave(@Validated SysDictType dict)
    {
        if (UserConstants.DICT_TYPE_NOT_UNIQUE.equals(dictTypeService.checkDictTypeUnique(dict)))
        {
            return error( MessageUtils.message("dict.modify") + " '" + dict.getDictName() + "' " + MessageUtils.message("dict.add.failed"));
        }

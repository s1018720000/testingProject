...
public class SysRoleController extends BaseController
{
    ...
    public AjaxResult addSave(@Validated SysRole role)
    {
        ...
        {
            return error(MessageUtils.message("user.role.add") + " '" + role.getRoleName() + "' " + MessageUtils.message("user.role.add.failed"));
        }
        else if (UserConstants.ROLE_KEY_NOT_UNIQUE.equals(roleService.checkRoleKeyUnique(role)))
        {
            return error(MessageUtils.message("user.role.add") + " '" + role.getRoleName() + "' " + MessageUtils.message("user.role.add.failed.permissions"));
        }
    ...
    public AjaxResult editSave(@Validated SysRole role)
    {
        ...
        if (UserConstants.ROLE_NAME_NOT_UNIQUE.equals(roleService.checkRoleNameUnique(role)))
        {
            return error(MessageUtils.message("user.role.modify") + " '" + role.getRoleName() + "' " + MessageUtils.message("user.role.add.failed"));
        }
        else if (UserConstants.ROLE_KEY_NOT_UNIQUE.equals(roleService.checkRoleKeyUnique(role)))
        {
            return error(MessageUtils.message("user.role.modify") + " '" + role.getRoleName() + "' " + MessageUtils.message("user.role.add.failed.permissions"));
        }

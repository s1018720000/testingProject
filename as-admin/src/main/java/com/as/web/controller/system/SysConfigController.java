...
import com.as.system.domain.SysConfig;
...
public class SysConfigController extends BaseController
{
    ...
    public AjaxResult addSave(@Validated SysConfig config)
    {
        ...
        {
            return error( MessageUtils.message("config.add.parameter") + " '" + config.getConfigName() + "' " + MessageUtils.message("config.parameter.exist"));
        }
    ...
    public AjaxResult editSave(@Validated SysConfig config)
    {
        if (UserConstants.CONFIG_KEY_NOT_UNIQUE.equals(configService.checkConfigKeyUnique(config)))
        {
            return error(MessageUtils.message("config.modify.parameter") + "'" + config.getConfigName() + "' " + MessageUtils.message("config.parameter.exist"));
        }

...
$(function() {
    ...
    function menuItem() {
        ...
        if (flag) {
            ...
            $.modal.loading(i18n('home.data.loading'));
    ...
    $.contextMenu({
        ...
        items: {
            ...
            "step": "---------",
            "full": {
                name: i18n('home.full.screen.info'),
                icon: "fa-arrows-alt",
                callback: function(key, opt) {
                    setActiveTab(this);
            ...
            "open": {
                name: i18n('home.open.new.window'),
                icon: "fa-link",
                callback: function(key, opt) {
                    var target = $('.RuoYi_iframe[data-id="' + this.data('id') + '"]');
